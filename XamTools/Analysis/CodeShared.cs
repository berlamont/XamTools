            ...
            try
            {
                ...
                var projects = new List<Solution>
                {
                    ...
                    new Solution
                    {
                        ...
                        {
                            Path.Combine(path, "XamTools.Android/XamTools.Android.csproj"),
                            Path.Combine(path, "XamTools/XamTools.csproj")
                        },
                    },
                    ...
                    new Solution
                    {
                        ...
                        ProjectFiles = new List<string>
                        {
                            Path.Combine(path, "XamTools.iOS/XamTools.iOS.csproj"),
                            Path.Combine(path, "XamTools/XamTools.csproj")
                        },
                    },
                };
